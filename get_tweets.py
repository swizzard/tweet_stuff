...
class Twitterizer(object):
    	...
    	"""
    	Initializes the Twitterizer object.
...
class Search(Twitterizer):
	...
	def __init__(self, _auth=None):
	    """
	    See documentation under Twitterizer, above
	    """
